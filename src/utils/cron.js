...
export const task = schedule(
  ...
  async () => {
    ...
    if (currentHour === 10) {
      message = 'Breakfast time has ended. Mark your meal status.'
    } else if (currentHour === 14) {
      message = 'Lunch time has ended. Mark your meal status.'
    } else if (currentHour === 20) {
      message = 'Dinner time has ended. Mark your meal status.'
    }
